...
#ifndef MCOLLISIONSHAPECOMPONENT_H
#define MCOLLISIONSHAPECOMPONENT_H
...
namespace MG
{
	...
	class MCollisionShapeComponent : public MComponent
	{
	...
	public:
		...
		virtual ~MCollisionShapeComponent();
...
#endif // MCOLLISIONSHAPECOMPONENT_H
